...
public class Test {
	...
	public static void main04(String[] args) {
		...
		System.out.println("1. 빈 컨테이너에 등록된 빈들의 이름을 알아내기.");
		for (String name : beanContainer.getBeanDefinitionNames()) {
			System.out.println(name);
		}
		
		System.out.println("2. 빈 컨테이너에 등록된 특정 빈의 별명 알아내기.");
		for (String alias : beanContainer.getAliases("s3")) {
	...
	public static void main03(String[] args) {
		...
		if ( s5 != null )
			System.out.println("s5 객체 생성되었음.");
		
	}

	/* ClassPathXmlApplicationContex
	 * 	- 빈 컨테이너 -> 설정 내용에 다라 빈을 생성하여 보관
	...
	public static void main02(String[] args) {
		...
		if ( s1 != null )
			System.out.println("s1 객체 생성되었음.");
	...
	public static void printScore(Score s) {
		System.out.format("%1$3s: %2$3d, %3$3d, %4$3d, %5$3d, %6$3.1f\n",
